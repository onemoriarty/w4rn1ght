...
<img src="https://i.ibb.co/XfFH8syR/seksi1.png" class="babe-img" style="position:fixed;bottom:0;left:0;width:280px;height:auto;max-height:85vh;object-fit:contain;z-index:9999;border:none;border-radius:0;margin:0;padding:0;pointer-events:none;background:transparent;filter:contrast(160%) brightness(110%);">

<img src="https://i.ibb.co/Fb3gqP0Y/seksi2.webp" class="babe-img" style="position:fixed;bottom:0;right:0;width:280px;height:auto;max-height:85vh;object-fit:contain;z-index:9999;border:none;border-radius:0;margin:0;padding:0;pointer-events:none;background:transparent;filter:contrast(170%) brightness(85%);">
     W4rN1ght WebShell
        </a>
